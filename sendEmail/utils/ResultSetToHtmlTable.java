...
//  public void writeTable(ResultSet rs, Writer writer, Column[] columns) throws IOException, SQLException {
  public String writeTable1(ResultSet rs, Writer writer, Column[] columns) throws IOException, SQLException {
    writer.write("<table>");
    // Write titles
    writer.write("\t<tr>\n");
  ...
  public String writeTable(ResultSet rs, Writer writer) throws IOException, SQLException {
    ...
    return writeTable1(rs, writer, columns);
  }
